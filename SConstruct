...
env.Append(CCFLAGS=['-FGA-SDK-GODOT/gameanalytics/ios/lib'])
env.Prepend(CXXFLAGS=[
    '-DNEED_LONG_INT', '-DLIBYUV_DISABLE_NEON', 
    '-DIPHONE_ENABLED', '-DUNIX_ENABLED', '-DCOREAUDIO_ENABLED'
])
env.Append(LINKFLAGS=["-arch", env['arch'], '-isysroot', sdk_path, '-F' + sdk_path, '-FGA-SDK-GODOT/gameanalytics/ios/lib'])
...
env.Append(CPPPATH=[
    ...
    'godot-headers/main', 
    'godot-headers/core', 
    'godot-headers/core/os', 
    'godot-headers/core/platform',
    'godot-headers/platform/iphone',
    'godot-headers/modules',
    'godot-headers/scene',
    'godot-headers/servers',
    'godot-headers/drivers',
    'godot-headers/thirdparty',
])

# tweak this if you want to use different folders, or more folders, to store your source code in.
sources = Glob('GA-SDK-GODOT/gameanalytics/*.cpp')
sources.append(Glob('GA-SDK-GODOT/gameanalytics/ios/src/*.mm'))
